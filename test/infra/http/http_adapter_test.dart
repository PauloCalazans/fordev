...
void main() {
  ...
  group('post', () {
    ...
    test('Should return ForbidenError if post returns 403', () {
      mockResponse(403);
  ...
  group('put', () {
    When<Future<Response>> mockRequest() => when(() => client.put(any(), body: any(named: 'body'), headers: any(named: 'headers')));
    ...
    test('Should return BadRequestError if put returns 400', () {
      mockResponse(400, body: '');
    ...
    test('Should return UnauthorizedError if put returns 401', () {
      mockResponse(401);
    ...
    test('Should return ForbidenError if put returns 403', () {
      mockResponse(403);
    ...
    test('Should return NotFoundError if put returns 404', () {
      mockResponse(404);
    ...
    test('Should return ServerError if put returns 500', () {
      mockResponse(500);
    ...
    test('Should return ServerError if put throws', () {
      mockError();
